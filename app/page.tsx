          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6 text-center">
                ...
                <div className="text-gray-700 text-base">Our jowar grinding service is a convenient and affordable way to
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6 text-center">
                ...
                <div className="text-gray-700 text-base">We specializes in the production of high-quality chili powder.
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6 text-center">
                ...
                <div className="text-gray-700 text-base">Our company produces high-quality rice papad that is made with
